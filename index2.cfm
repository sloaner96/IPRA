...
adImages = new Array("images/staff/ParkPursuitAnimated.gif")
...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=459,height=360,left = 289.5,top = 211.5');");
}
// End -->
</script>

<BODY onLoad="javascript:popUp('http://www.ilipra.org/ad.htm')">
</body>
...
<a href="mailto:&#109;&#97;&#116;&#116;&#64;&#105;l&#105;&#112;&#114;&#97;.o&#114;&#103;&#63;&#115;&#117;&#98;je&#99;t&#61;&#80;&#114;&#101;&#115;&#115;&#32;R&#101;&#108;&#101;a&#115;&#101;&#32;&#80;&#111;s&#116;&#105;n&#103;" style="color:0000ff; font-family:arial; size:10px;">E-mail Your Press Releases!</a>--->
	   ...
	   <td width="400" valign="top">
		 ...
		 <table border="0" cellpadding="0" cellspacing="0" width="100%">
		   <tr>
                 <td><A HREF="/Events/ListEvents.cfm?mode=day&day=22&month=9&year=2006"><IMG SRC="images/staff/ParkPursuitAnimated.gif" WIDTH="400" HEIGHT="104" NAME="adBanner" BORDER="0" ALT="What's New at IPRA!!!"></A></td>
              </tr>
		 </table>
		 </body>
		 <table border="0" cellpadding="4" cellspacing="0" width="95%">
			<!--- <cfoutput query="GetArticle"> --->
			<tr>&nbsp;&nbsp;<img src="/images/blogspotnews.jpg" alt="" border="0" align="center"><br><font size="1" color="#006699">&nbsp;&nbsp;The following news stories are from IPRA's blog, The Blog Spot.</font>
...
&nbsp;<img src="images/mock3arrow.gif">&nbsp;<a href="Resources/enews/ENewsletterJuly06.htm"><img src="images/enewsletter.jpg" border="0"></a><br>
...
&nbsp;<img src="images/mock3arrow.gif">&nbsp;<a href="/members/coop/index.cfm" target="_blank"><img src="images/coopquick.jpg" border="0"></a><br>
			...
			<tr>
			  <td align="center">
			    <table border="0" cellpadding="3" cellspacing="0">
					...
					&nbsp;&nbsp;&nbsp; <td valign="middle"><a href="http://ipra.blogspot.com" target="_blank"><img src="images/theblogspotanimatedad100x44.gif" alt="The Blog Spot" border="0"></a></td>
                      </tr>
