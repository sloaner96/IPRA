...
<cfif ArrayLen(ErrorList) eq 0>
	<cfmail to="dean@ilipra.org" from="webmaster@ilipra.org" subject="Tech KnowHow Volunteer Submission Form" type="html" server="#Application.Mailserver#" username="#Application.MailUser#" password="#Application.MailPassword#">
		An Individual submitted volunteer information for the TechKnowHow Page. Below is the information they submitted.
		<br><br>
...
<cfmodule template="#Application.header#" sectiontitle="Tech KnowHow Volunteer Submission Page">
  <cfoutput>
	    ...
	    <tr>
		   ...
		   <td valign="top"><br>
			  <table border="0" cellpadding="5" cellspacing="0" width="100%">
		        <tr>
		          <td><h3>Tech KnowHow Volunteer Submission Page</h3></td>
		        </tr>
		      </table>
			  ...
			  <table border="0" cellpadding="6" cellspacing="0" width="100%">
		        <tr>
		           <td class="RegText">
                        <p><strong>Thank you #Form.Name# for submitting your volunteer information. Your information has been sent to the appropriate person at IPRA.</strong></p>
				   </td>
		        </tr>
		       </table>
			   <br>
