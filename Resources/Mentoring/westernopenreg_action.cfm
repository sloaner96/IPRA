...
<cfif ArrayLen(ErrorList) eq 0>
	<cfmail to="dean@ilipra.org" from="webmaster@ilipra.org" subject="Western Open Volunteer Form" type="html" server="#Application.Mailserver#" username="#Application.MailUser#" password="#Application.MailPassword#">
		An Individual signed up as a volunteer for the 2005 Cialis Western Open. Below is the information they submitted.
		<br><br>
