...
<CFIF Form.college1 is "">
	<cfset x = ArrayAppend(ErrorList, "No value specified for the <b>College 1</b> field")>
</CFIF>
<CFIF Form.Degree1 is "">
	<cfset x = ArrayAppend(ErrorList, "No value specified for the <b>Degree 1</b> field")>
</CFIF>
<cfif ArrayLen(ErrorList) eq 0>
	<cfmail to="dean@ilipra.org" from="webmaster@ilipra.org" subject="Mentor Volunteer Form" type="html" server="#Application.Mailserver#" username="#Application.MailUser#" password="#Application.MailPassword#">
		An Individual signed up as a mentor volunteer. Below is the information they submitted.
		<br><br>
	    ...
	    <tr>
		   ...
		   <td valign="top"><br>
			  <table border="0" cellpadding="5" cellspacing="0" width="100%">
		        <tr>
		          <td><h3>Mentoring Committee Registration</h3></td>
		        </tr>
		      </table>
			  ...
			  <table border="0" cellpadding="6" cellspacing="0" width="100%">
		        <tr>
		           <td class="RegText">
                        <p><strong>Thank you #Form.Name# for registering, You information has been sent to the appropriate person at the IPRA.</strong></p>
				   </td>
		        </tr>
		       </table>
			   <br>
