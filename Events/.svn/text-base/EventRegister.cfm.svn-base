...
<cfquery name="EventNfo" datasource="#Application.DSN#">
 ...
 <cfif EventNfo.RecordCount EQ 0>
...
<cfmodule template="#Application.header#" sectiontitle="Event Registration">
	 <table border="0" cellpadding="3" cellspacing="0" width="100%">
				    ...
				    <table border="0" cellpadding="2" cellspacing="0" width="100%">
					  <cfloop Query="GetChargeDetail">
                       <tr>
						  ...
						  <td width="14%" align="right"><strong>Quantity:</strong> <input type="text" name="EvtQty_#GetChargeDetail.EventDetailID#" value="0" size=3 maxlength="3"></td>
                       </tr>
		...
		<tr>
			...
			<td width=* align=left><cfinput type="Text" name="FirstName" size="20" maxlength="35"></td>
		</tr>
		
		<tr>
			<td width=120 align=left><font face="Verdana,Arial" size="-1"><b>Last Name</b></font>:</td>
			<td width=* align=left><cfinput type="Text" name="LastName" size="25" maxlength="40"></td>
		</tr>
		
		<tr valign=top>
			<td width=120 align=left><font face="Verdana,Arial" size="-1"><b>Company</b></font>:</td>
			<td width=* align=left><cfinput type="Text" name="Company" size="35" maxlength="70"><br>&nbsp;</td>
		</tr>
		
		<tr valign=top>
			<td width=120 align=left><font face="Verdana,Arial" size="-1"><b>Email Address</b></font>:</td>
			<td width=* align=left><cfinput type="Text" name="Email" size="35" maxlength="100"> <font color="757575">(you@email.com)</font><br>&nbsp;</td>
		</tr>
		<tr valign=top>
			<td width=120 align=left><font face="Verdana,Arial" size="-1"><b>Phone Number</b></font>:</td>
			<td width=* align=left><cfinput type="Text" name="Phone" size="20" maxlength="15"> <font size="-2" face="arial" color="757575">(555-555-5555)</font><br>&nbsp;</td>
		</tr>
		</table>
		 <table border="0" cellpadding="4" cellspacing="0" width="100%">
                         <tr bgcolor="#003366">
