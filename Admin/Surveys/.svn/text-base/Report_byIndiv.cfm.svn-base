...
<table bgcolor="white" border="1" cellpadding="5" cellspacing="0" align="center" width="600">
	<tr>
		...
		<br><br>
		<a href="Report_byIndiv_pfv.cfm?sid=#sid#&respID=#respID#&srID=#srID#"><img src="/images/Surveys/printer_icon.gif" border="0">&nbsp;&nbsp;Printer-friendly Version</a>
		</cfoutput></td>
	</tr>
	<cfset catMarked="">
	<cfset catCurrent="">
	...
	<cfif getRespondent.srComments neq "">
	<cfoutput>
	<tr>
		<td colspan="2"><strong>Additional Comments:</strong><br>#getRespondent.srComments#</td>
	</tr>
	</cfoutput>
	</cfif>
	</table>
	...
	<br><br>
	<cfoutput>
	<div align="center"><form name="delete" action="Survey_ConfirmDelResponse.cfm?sid=#sid#&srID=#srID#&group=#group#" method="post">
