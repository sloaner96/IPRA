...
<form name="form1" action="Scale_InsertValuesAdd.cfm?scID=#scID#" method="post">
<cfloop index="x"
		from="1"
		to="#form.val_num#">
...
<br><br>
<form name="form2" onSubmit="return check2();" action="Scale_whatValuesAdd.cfm?scID=#scID#" method="post">
