<cfmodule template="#Application.header#" section="0" sectiontitle="Certification Plan">
  <cfoutput>
	    ...
	    <tr>
		   ...
		   <td valign="top"><br>
			  <table border="0" cellpadding="5" cellspacing="0" width="100%">
		        <tr>
		          <td><h3>Certification Plan</h3></td>
		        </tr>
		      </table>
			  <table border="0" cellpadding="6" cellspacing="0" width="100%">
		        <tr>
		           <td class="RegText">
                        ...
                        <p>The National Certification Plan
                        (endorsed by NRPA) was approved and
                        implemented in 1981. The IPRCB plan was
                        adopted in 1986. The IPRCB Plan exceeds
                        the minimum qualifications of the NCB.
                        These plans outline the process of
                        certification for park &amp; recreation personnel. Illinois' certification
                        process is designed to: formally
                        recognize individuals who fulfill the
                        requirements of certification; encourage
                        professional growth and individual study;
                        provide a standard of knowledge desirable
                        for park &amp; recreation professionals.</p>
