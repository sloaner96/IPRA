        ...
        <tr>
           <td width="178" valign="top">
			 ...
			 <cfelse>
		      ...
		      <cfform name="login" action="MembersOnly/Authorize.cfm" method="POST"> 
...
&nbsp;&nbsp;<a href="/Articles.cfm?AID=17" style="color:ffffff; font-family:arial; size:10px;">Need Login Help?</a>
			  ...
			  <table border="0" cellpadding="3" cellspacing="0" color="ffffff">
				<tr>
				   <td colspan=2><img src="/images/UpcomingEventsBanner.jpg" alt="Upcoming Events" border="0"></td>
				</tr>
				...
				<table border="0" cellpadding="3" cellspacing="0" color="ffffff">
				<tr>
				   <td colspan=2><img src="/images/inthenews.gif" alt="" border="0"></td>
				</tr>
			 ...
			 <table border="0" cellpadding="4" cellspacing="0" width="95%">
				...
				<tr>
				  <td><span class="Newsdate">#DateFormat(GetArticle.PostingDate, 'mmmm dd, yyyy')#&nbsp;&nbsp;</span>
					  ...
					  <cfelse>
					    <span class="NewsMore">#SpanExcluding(GetArticle.Articletext, Chr(46))# ... <a href="Articles.cfm?AID=#GetArticle.ArticleID#" style="color:##cc0000;">Read more >></a></span>
				      </cfif>
				  </td>
				</tr>
				<tr><td>&nbsp;</td></tr>
		   ...
		   <td width="225" valign="top">
				...
				<tr>
				  <td align="center">
				    <table border="0" cellpadding="3" cellspacing="0">
                       <tr>
                         <td valign="top"><a href="http://www.awesomeamusements.com" target="_blank"><img src="images/awesome.gif" alt="A-Awesom Amusements" border="0"></a></td>
			  ...
			  <table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
                                  <td align="center"><a href="http://www.microtrain.net" target="_blank"><img src="images/microtrain.jpg" alt="Microtrain" border="0"></a></td>
                               </tr>
              </table><br>
		   </td>
        </tr>
