...
<CFIF Form.starts is "">
	<cfset x = ArrayAppend(ErrorList, "No value specified for the <b>Event Start Date</b> field")>
</CFIF>
<CFIF Form.ends is "">
	<cfset x = ArrayAppend(ErrorList, "No value specified for the <b>Event End Date</b> field")>
</CFIF>
...
<cfif ArrayLen(ErrorList) eq 0>
	<cfmail to="matt@ilipra.org" from="webmaster@ilipra.org" subject="Event Request Form" type="html" server="#Application.Mailserver#" username="#Application.MailUser#" password="#Application.MailPassword#">
