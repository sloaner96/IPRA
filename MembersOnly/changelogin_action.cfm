...
<cfif Len(trim(form.username)) EQ 0>
  ...
  <meta http-equiv="refresh" content="0;url=changelogin.cfm?e=1">
</cfif>
 <!--- comment starts here ---> 
<!--- <cftry>
<cfinvoke 
...
<cfif Len(trim(form.password1)) EQ 0>
  ...
  <meta http-equiv="refresh" content="0;url=changelogin.cfm?e=2">
</cfif>

<cfif Len(trim(form.password2)) EQ 0>
  <!--- <cflocation url="changelogin.cfm?e=3" addtoken="no"> --->
  <meta http-equiv="refresh" content="0;url=changelogin.cfm?e=3">
</cfif>

<cfif password1 NEQ password2>
 <!---  <cflocation url="changelogin.cfm?e=4" addtoken="no"> --->
  <meta http-equiv="refresh" content="0;url=changelogin.cfm?e=4">
</cfif>
...
<cfmail to="#form.username#" 
		...
		subject="New Login Information for ILIPRA.ORG" server="#Application.mailserver#" username="#Application.MailUser#" password="#Application.MailPassword#">
