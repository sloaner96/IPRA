								    ...
								    <cfif ISDefined("Session.MyCoopReg")>
									    <cfif Session.MyCoopReg.recordcount EQ 0>
											  <cfif Session.CoopConfig.CoopEnrollmentEnd GT now()>
											       <div><a href="#Application.SecureURL#/MembersOnly/coop/register.cfm"><img src="/images/coopbanner2.jpg" alt="Coop Program Sign-up!" border="1" align="right" style="border-color:000000: 1px;"></a></div>
										      </cfif>
										<cfelse>
											  <cfif Session.CoopConfig.OrderBegin LTE now() AND Session.CoopConFig.OrderEnd GTE now()>
										         <div> <a href="/MembersOnly/coop/index.cfm"><img src="/images/coopOrderBanner1.jpg" alt="Coop Program Sign-up!" border="1" align="right" style="border-color:000000: 1px;"></a></div>
											  </cfif>
										</cfif> 
								  </cfif>
							  </cfif>
...
<hr noshade>
								  ...
								  <li><a href="/forms/MembersOnly/StrategicPlan2006-2007.pdf" target="_blank">2006 Strategic Plan</a>
								  <br>
								  <br>
