...
<div id="pagecell1"> 
  ...
  <div id="content"> 
    <div class="feature"> 
	<cfmail to="dean@ilipra.org" from="#form.name#" subject="Relocation FAQ Submission" type="html" server="#Application.MailServer#" username="#Application.MailUser#" password="#Application.MailPassword#">
<br><br>
<cfloop index="thefield" list="#form.fieldnames#">
    ...
    <cfelse>
      ...
      <img src="faq.gif" alt="" width="145" height="138"> 
     <cfoutput>
	  <h3> Member Feedback </h3> 
      <p>
       Thank you, <i>#form.name#</i>, your FAQ has been submitted to IPRA staff. After being reviewed and approved, it will be posted to this site. If you have any questions, please contact <a href="mailto:dean@ilipra.org">Dean Comber</a>. <br>
       <br>
      </p></cfoutput>
