		      ...
		      <td>
			       <cfif IsDefined("form.username")>
					 ...
					 <!--- Call Password Finder --->
	   				    <cfset checklogin = request.CareersComponent.getResumePassword(Trim(form.username), trim(form.lastname))>
					 
					 <cfif checklogin.recordcount GT 0>
					 <!--- Send Email --->
					    <cfset sendtoname = "#trim(checklogin.firstname)# #trim(checklogin.lastname)#">
					    <cfset sendPassword = request.CareersComponent.sendPassword(sendtoname, trim(checklogin.username), trim(checklogin.password), trim(checklogin.Email))>
					 ...
					 <cfif url.e NEQ 0>
					    <table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<cfelseif url.e EQ 2>
							  <tr>
		                        <td class="errortext" align="center"><img src="/images/Error.gif" width="26" height="26" alt="" border="0">ERROR! You must your lastname.</td>
		                      </tr>
							<cfelseif url.e EQ 3>
							  <tr>
				   ...
				   <cfelse>
					   ...
					   <cfform name="login" action="forgotpassword.cfm" method="POST"> 
					      <table border="0" cellpadding="3" cellspacing="0" width="200">
							...
							<tr>
							   <td width=10>&nbsp;</td>
			                   <td><cfinput type="text" name="lastname" size="18" value="" maxlength="75" required="Yes" Message="Your lastname is required to have your password sent to you."></td>
			                </tr>
							<tr>
