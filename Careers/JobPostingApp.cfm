...
function activeButton(){
     if (document.theform.MemoOfUnderstanding.checked = false){
	   document.theform.thesubmit.disabled = true;
	 } else {
	   document.theform.thesubmit.disabled = false;
	   document.theform.MemoOfUnderstanding.checked = true;
	 }
			  ...
			  <table border="0" cellpadding="6" cellspacing="0" width="100%" class="regtext">
			   ...
			   <cfform name="theform" action="/Careers/processPayment.cfm" method="POST" scriptsrc="/scripts/cfform.js">
				  ...
				  <cfquery name="GetState" datasource="#Application.dsn#" cachedwithin="#CreateTimeSpan(0,0,10,0)#">
			        ...
			        <cfif IsDefined("Session.UserInfo.IPRACOID")>
				   ...
				   <cfelseif IsDefined("form.AgencyFind")>
					  <cfquery name="MyAgencySearch" datasource="#Application.dsn#">
							  Select *
							  from Agencies
							  <cfif IsDefined("form.agencyFind")>
					  ...
					  <cfif MyAgencySearch.recordcount GT 0>
					    <cfset Session.JobPosting.AgencyInfo.AgencyID ="#MyAgencySearch.AgencyID#">
				        <cfset Session.JobPosting.Agencyinfo.AgencyName = "#MyAgencySearch.AgencyName#">
					    <cfset Session.JobPosting.Agencyinfo.Addr1 = "#MyAgencySearch.Addr1#">
					    <cfset Session.JobPosting.Agencyinfo.Addr2 = "#MyAgencySearch.Addr2#">
					 ...
					 <tr>
					    <td>
						   ...
						   <table border="0" cellpadding="4" cellspacing="0" width="100%">
							 ...
							 <tr>
                                <td><font face="Verdana,Arial" size="-1"><b>Allow Resume Submittal Via IPRA Online Resume Builder:</b></font></td>
								<td><input type="checkbox" name="AllowApp" value="1"> <font color="red"><strong>YES!</strong></font> (by selecting "Yes", you allow people with completed resumes in the IPRA Resume Builder the ability to apply for a job online. If you do not choose this option, you will still be able to search resumes, however, applicants will not be able to apply online. IPRA highly recommends utilizing this feature.)</td>
                              </tr>
							  <tr>
				  ...
				  <table border="0" cellpadding="6" cellspacing="0" width="100%">
				   ...
				   <tr>
				     <td><textarea name="termtext" cols="65" rows="10">Please read this carefully and be aware that in electing to participate in the IPRA Resume Builder you are expressly assuming the risk and legal liability and waiving and releasing all claims for injury, civil or criminal, damages or loss against the Illinois Park & Recreation Association in total which you may sustain as a result of participating in any and all connecting current or future activities which may arise from use of the IPRA Job Opportunities Bulletin and Resume Builder.
 
In participating and checking the box above when posting a job, you hereby fully release and forever discharge the Illinois Park & Recreation Association, Board of Directors, Staff, Volunteers and association in total from any and all claims for injuries, damages or loss which may accrue and rising out of, connected with, or in any way associated with use of the IPRA Job Opportunities Bulletin and Resume Builder. 
If you have any questions regarding the information above, please contact the Illinois Park & Recreation Association at 630-376-1911 or webmaster@ilipra.org. For more information regarding our privacy policy, please go to http://www.ilipra.org/privacy.cfm.</textarea></td>
				   </tr>
				   <tr>
				  ...
				  <table border="0" cellpadding="6" cellspacing="0" width="100%">
				   ...
				   <cfoutput>
                      ...
                      <tr>
                        <td align="center">
					       <font face="Verdana,Arial" size="-1">
					         <input type="submit" name="thesubmit" value="Complete Posting >>" onclick="javascript:disableForm(this);" disabled="true">
					       </font>
					    </td>
                      </tr>
                     </table>
					...
					<p>If you chose a credit card as your method of payment, This will initiate a <b>secured</b> transaction to the bank which will validate the credit information you provided and authorize the transfer of funds.  <strong>The authorization process may take up to 1 minute (depending on your connection speed) to complete. PLEASE BE PATIENT!</strong> </p>
					</font>
