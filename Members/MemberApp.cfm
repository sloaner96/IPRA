		        ...
		        <tr>
		           <td class="RegText">
				       <table border="0" cellpadding="0" cellspacing="0" width="100%">
                         <tr>
                           <td>
						   <p><strong><font color="red">This online application is for NEW MEMBERS ONLY!!! If you would like to renew your membership with IPRA, please contact <script type="text/javascript">
user ="polly"
domain ="ilipra.org"
subCon ="IPRA Member Application Inquiry"
document.write('<a href="mailto:' + user + '@' + domain +'?subject=' +subCon+' " ' +' >Polly McKee</a>');
</script> via e-mail or at 630-376-1911. </font></strong></p>
						   <p>IPRA membership expires each year on December 31.
	                 ...
	                 <tr>
					   ...
					   <table border="0" cellpadding="3" cellspacing="0">
						  ...
						  <tr>
						   ...
						   <tr>
				           <td class="RegText" valign="top"><strong>I prefer my mail to be sent to:</strong></td>
						   <td  valign="top"><input type="radio" name="wheremail" value="agency" checked>Agency<br>
						                     <input type="radio" name="wheremail" value="Home">Home<br>
											 <input type="radio" name="wheremail" value="Campus">Campus&nbsp;&nbsp;</td>
				          </tr>
						  <tr>
						  ...
						  <tr>
				           <td class="RegText" valign="top"><strong>Who Is responsible for paying your dues?:</strong></td>
						   <td  valign="top"><input type="radio" name="whopays" value="ind" checked>Individual<br><input type="radio" name="whopays" value="agency">Agency Pays All<br><input type="radio" name="whopays" value="agencyPortion">Agency Pays Portion&nbsp;&nbsp;</td>
				          </tr>
						   <tr>
				           <td class="RegText"><strong>Who encouraged you to join:</strong></td>
						   <td><input type="text" name="referral" value="" size="30" maxlenth="100"></td>
				          </tr>
						  <tr>
						    <td colspan=2>&nbsp;</td>
						  </tr>
					   ...
					   <cfquery name="GetPayType" datasource="#Application.dsn#" cachedwithin="#CreateTimeSpan(0,0,10,0)#">
						   ...
						   <cfoutput>
							...
							<script src=https://seal.verisign.com/getseal?host_name=www.ilipra.org&size=S&use_flash=YES&use_transparent=YES&lang=en></script><center><img src="/images/credit_card_bar.gif" alt="" border="0"></center>
